      ...
      <main className="pt-40">
        ...
        <section className="px-6 md:px-12 lg:px-24 mb-32 max-w-7xl mx-auto">
          <div className="space-y-8 max-w-5xl">
            ...
            <AnimatedTitle
              ...
              className="font-['Manrope'] text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight leading-[1.05] text-[#dce3f0]"
            />
        ...
        <section className="space-y-40 mb-40">
          ...
          <article className="relative px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-start-2 md:col-span-10 lg:col-start-3 lg:col-span-8 relative z-10 bg-[#2e353f]/40 backdrop-blur-xl p-8 md:p-16 rounded-lg border border-[#45474b]/10">
              <AnimatedTitle as="h2" text="Error 01: La Falacia de la &quot;Primera Línea&quot; de Mar" className="font-['Manrope'] text-3xl md:text-4xl font-bold mb-8 text-[#e4c0a0]" />
          ...
          <article className="relative px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-start-1 md:col-span-10 lg:col-start-2 lg:col-span-8 relative z-10 bg-[#151c26] p-8 md:p-16 rounded-lg">
              <AnimatedTitle as="h2" text="Error 02: Rendimientos Garantizados por Contrato" className="font-['Manrope'] text-3xl md:text-4xl font-bold mb-8 text-[#e4c0a0]" />
              <div className="space-y-6 text-[#c5c6cc] leading-loose text-lg">
          ...
          <article className="relative px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-start-2 md:col-span-10 lg:col-start-3 lg:col-span-8 relative z-10 bg-[#2e353f]/40 backdrop-blur-xl p-8 md:p-16 rounded-lg border border-[#45474b]/10">
              <AnimatedTitle as="h2" text="Error 03: Ignorar el Costo de Mantenimiento Tropical" className="font-['Manrope'] text-3xl md:text-4xl font-bold mb-8 text-[#e4c0a0]" />
              <div className="space-y-6 text-[#c5c6cc] leading-loose text-lg">
          ...
          <article className="relative px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-start-3 md:col-span-10 lg:col-start-4 lg:col-span-8 relative z-10 bg-[#151c26] p-8 md:p-16 rounded-lg">
              <AnimatedTitle as="h2" text="Error 04: Confiar en el &quot;Boom&quot; sin Infraestructura" className="font-['Manrope'] text-3xl md:text-4xl font-bold mb-8 text-[#e4c0a0]" />
              <div className="space-y-6 text-[#c5c6cc] leading-loose text-lg">
          ...
          <article className="relative px-6 md:px-12 lg:px-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div className="md:col-start-2 md:col-span-10 lg:col-start-3 lg:col-span-8 relative z-10 bg-[#2e353f]/40 backdrop-blur-xl p-8 md:p-16 rounded-lg border border-[#45474b]/10">
              <AnimatedTitle as="h2" text="Error 05: Falta de Estructura Legal Institucional" className="font-['Manrope'] text-3xl md:text-4xl font-bold mb-8 text-[#e4c0a0]" />
              <div className="space-y-6 text-[#c5c6cc] leading-loose text-lg">
        ...
        <section className="bg-[var(--color-dark-navy)] px-8 py-20 md:py-24 text-center border-t border-white/5 relative z-20">
          <div className="max-w-3xl mx-auto space-y-8 flex flex-col items-center">
            ...
            <p className="font-sans text-gray-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Evita la especulación. Agenda una consultoría privada para analizar el mercado y tus objetivos patrimoniales.
            </p>
            <div className="pt-6">
              <Link 
                href="/#contacto" 
                className="inline-block bg-[var(--color-copper)] text-white px-10 py-5 rounded-sm font-sans font-medium hover:bg-[#8C4F10] transition-colors tracking-wide text-[15px]"
              >
