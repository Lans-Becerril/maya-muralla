      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            ...
            <div
              className={`mt-12 pt-10 border-t border-[rgba(255,255,255,0.05)] transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
            >
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <div className="flex items-center gap-5">
                  ...
                  <a href="http://x.com/"
                    ...
                    className="text-[rgba(241,241,241,0.5)] hover:text-[var(--color-copper)] transition-colors">
