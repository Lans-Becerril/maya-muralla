  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between h-[4.5rem]">
        ...
        >
          <span
            className={`block w-6 h-[1.5px] bg-[var(--color-on-surface)] transition-all duration-300 ${
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 top-[4.5rem] bg-white/98 backdrop-blur-xl transition-all duration-500 md:hidden flex flex-col items-center justify-start pt-16 gap-8 ${
          mobileOpen
